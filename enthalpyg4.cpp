...
double EnthalpyG4::DeltaH_ElementsExperimental(int atn){
        ...
        static const double g40K[]={ 0.0, 216.03500, 0.0, 157.80000, 317.10000, 569.90000, 711.79000, 470.82000,
                246.79000, 77.40000, 0.0, 107.60000, 146.50000, 327.30000, 452.30000, 315.60000, 274.73500,
...
double EnthalpyG4::EnthalpyResult(EnthalpyInputData &input){
	...
	cout << "                                                                                                   " << endl;
        ...
        cout << "                                                                                                   " << endl;
        cout << "       Enthalpies of formation of gaseous atoms at 0 K (with the exception of carbon data          " << endl;
        cout << "        711.79 kJ/mol from A. Tajti et al. J. Chem. Phys. 121, 2004, 11599) and thermal            " << endl;
        cout << "             corrections for elements in their standard states at 298.15 K from:                   " << endl;
	cout << "                                                                                                   " << endl;
